...
<div class="row me-2 me-md-5">
    ...
    <div class="container text-center col-10 col-sm-9 col-xxl-9 col-md-9 mt-2 me-md-0 ">
        ...
        <div class="text-end mt-3">
            <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#listaAgendamentoModal">
        ...
        <div id="corpo_calendario">
            <h1 class=" p-3 my-4 bg-dark text-white rounded">Horários - Nome do equipamento</h1>
            <div id='calendar'></div>
        </div>
